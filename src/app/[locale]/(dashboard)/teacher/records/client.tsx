...
import { deleteSessionNote, deleteSessionDocument } from '../../bookings/[id]/actions';
...
interface TeacherRecordsClientProps {
...
export function TeacherRecordsClient({
  records,
  parents,
  currentUserId,
  currentFilters,
}: TeacherRecordsClientProps) {
  ...
  const hasFilters =
    currentFilters.parentId || currentFilters.startDate || currentFilters.endDate || currentFilters.search;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <Select
          value={currentFilters.parentId || 'all'}
          onValueChange={(value) => updateFilters('parentId', value === 'all' ? null : value)}
        >
      ...
      {recordsWithContent.length > 0 ? (
        ...
        <div className="text-center py-12 text-muted-foreground">
          ...
          <p className="text-sm">{t('noRecordsDescription')}</p>
        </div>
      )}
    </div>
  );
